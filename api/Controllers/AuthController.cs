...
/// <summary>
/// Controller OTP về SĐT (FR1.2): xác thực đăng ký + quên mật khẩu.
...
public class AuthController : ControllerBase
{
    ...
    /// purpose = "Register" hoặc "ResetPassword".
    /// </summary>
    [HttpPost("resend-otp")]
    ...
    /// <summary>
    /// Bước 1 quên MK: gửi OTP 6 số về SĐT đã đăng ký.
    /// Dev: xem mã trong log server ([DEV OTP SMS]).
    /// </summary>
    ...
    /// <summary>
    /// Bước 2 quên MK: xác thực OTP → nhận resetToken (vé tạm để đổi MK).
    /// </summary>
    [HttpPost("verify-otp")]
    public async Task<IActionResult> VerifyOtp([FromBody] PhoneOtpDto dto)
    {
