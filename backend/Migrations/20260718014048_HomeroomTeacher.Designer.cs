...
namespace Api.Migrations
{
    ...
    [Migration("20260718014048_HomeroomTeacher")]
    partial class HomeroomTeacher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.Grade", b =>
                {
                    ...
                    b.HasIndex("StudentId", "ClassId", "SubjectId", "SemesterId", "AssessmentType")
                        .IsUnique();
            ...
            modelBuilder.Entity("Api.Models.PasswordResetOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Models.PaymentGatewayConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Models.TimetableSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClassId", "DayOfWeek", "Period")
                        .IsUnique();
            ...
            modelBuilder.Entity("Api.Models.Attendance", b =>
                {
                    ...
                    b.HasOne("Api.Models.User", "RecordedByTeacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Models.Class", b =>
                {
                    b.HasOne("Api.Models.User", "HomeroomTeacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Models.LeaveRequest", b =>
                {
                    ...
                    b.HasOne("Api.Models.User", "SubmittedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Models.PaymentTransaction", b =>
                {
                    b.HasOne("Api.Models.FeeInvoice", "FeeInvoice")
            ...
            modelBuilder.Entity("Api.Models.Submission", b =>
                {
                    ...
                    b.HasOne("Api.Models.User", "GradedByTeacher")
                        .WithMany()
