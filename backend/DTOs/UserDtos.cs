...
// ─── OTP: đăng ký = SĐT · quên MK = Email ───────────────────────────────────

/// <summary>Body xác thực OTP đăng ký (verify-phone) — theo SĐT.</summary>
...
/// <summary>Body bước 1 quên MK — gửi OTP về email đã gắn hồ sơ.</summary>
public class ForgotPasswordDto
{
    public string Email { get; set; } = string.Empty;
}

/// <summary>Body bước 2 quên MK — xác thực OTP nhận qua email.</summary>
...
/// <summary>Response sau khi gửi OTP (masked đích + TTL).</summary>
...
/// <summary>
/// Body gửi lại OTP.
/// Register → bắt buộc Phone; ResetPassword → bắt buộc Email.
/// </summary>
