...
///   + cờ [isHomeroom] từ `Class.HomeroomTeacherId`.
...
class TeacherClassModel {
  ...
  /// True nếu GV là chủ nhiệm lớp (không chỉ bộ môn).
  final bool isHomeroom;

  /// True = kênh gửi tin chủ nhiệm (không gắn môn); false = tin bộ môn.
  final bool isHomeroomChannel;
  ...
  TeacherClassModel({
    ...
    this.isHomeroomChannel = false,
  });

  /// Dòng ảo: CN gửi tin lớp (không môn).
  factory TeacherClassModel.homeroomChannel(TeacherClassModel from) {
    return TeacherClassModel(
      assignmentId: 0,
      classId: from.classId,
      className: from.className,
      subjectId: 0,
      subjectName: 'Tin chủ nhiệm',
      subjectCode: '',
      semesterId: from.semesterId,
      semesterName: from.semesterName,
      isHomeroom: true,
      isHomeroomChannel: true,
    );
  }
